...
#SBATCH --output=logs/resnet/out_naki_lwap_sm.%j     # Name of stdout output file
#SBATCH --error=logs/resnet/err_naki_lwap_sm.%j      # Name of stderr error file
...
# export checkpoint="exp_naki/resnet_base/model_00.pt"
export checkpoint="${exp_dir}/models/model_6.pt"
# export gpus="[0,1,2,3,4,5,6,7]"
export gpus="[0]"
export num_avg=5
export config=conf/resnet_naki.yaml
