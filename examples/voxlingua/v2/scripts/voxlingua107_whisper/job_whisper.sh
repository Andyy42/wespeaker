#!/bin/bash -l
#SBATCH --job-name=VoxLingua107-Whisper-generic # Job name
#SBATCH --output=logs/whisper/out_voxlingua107.%j     # Name of stdout output file
#SBATCH --error=logs/whisper/err_voxlingua107.%j      # Name of stderr error file
...
SCRIPT_DIR="$PROJ_DIR/projects/wespeaker_voxlingua_v2/scripts/voxlingua107_whisper"
SCRIPT="$SCRIPT_DIR/run_whisper.sh"
...
export exp_dir="exp_voxlingua107/Whisper-no-margin-SGD-epoch20"

export PATH="/scratch/project_465001402/xodehn09/envs/py311_rocm622_pytorch/env/bin:$PATH" 

# export checkpoint="${exp_dir}/models/model_19.pt"
# export gpus="[0,1,2,3,4,5,6,7]"
export gpus="[0]"
export num_avg=5
export config=conf/whisper_small_MHFA_LR.yaml
