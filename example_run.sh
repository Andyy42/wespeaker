...
model_path="naki-example/model/NAKI-I-WavLM-BasePlus-MHFA-emb256-3s-LRS10-Epoch20-no-margin/model.pt"

export PYTHONPATH=$PYTHONPATH:$(pwd); $manager run -n py_torch24_cpu python wespeaker/bin/extract_single_V2.py \
  --input_wav "${input_wav}" \
